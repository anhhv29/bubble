...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) final View increaseNotification = findViewById(R.id.increase_button);
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) final View decreaseNotification = findViewById(R.id.decrease_button);
